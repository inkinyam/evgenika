      ...
      <AppBackground isLoading={isLoading}>
        ...
        <main>
          <Navigations>
            ...
            {concertCards.length > 0 && (
              <NavigationsItem link="#concerts" text="Концерты" />
            )}
            {trackCards.length > 0 && (
              <NavigationsItem link="#tracks" text="треки" />
            )}
            {publicationCards.length > 0 && (
              <NavigationsItem link="#news" text="новости" />
            )}
            {videoCards.length > 0 && (
              <NavigationsItem link="#videos" text="клипы" />
            )}
            {guidesCards.length > 0 && (
              <NavigationsItem link="#guides" text="продукция" />
            )}
          ...
          {videoCards.length > 0 && (
            <Videos data={videoCards} social={socialCards} />
          )}
          {guidesCards.length > 0 && <Guides data={guidesCards} />}
        </main>

        <Footer
          concertContact={concertContactCards}
